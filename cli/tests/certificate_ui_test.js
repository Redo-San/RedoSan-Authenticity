...
globalThis.getResult = globalThis.getResult || function () { return null; };
...
globalThis.document = {
  getElementById: function (id) {
    if (!elStore[id]) {
      elStore[id] = { value: "", style: {}, checked: false, display: "", files: null, disabled: false, textContent: "", maxLength: -1, onclick: null, classList: { add: function () {}, remove: function () {} } };
    }
    return elStore[id];
  },
  readyState: "complete",
  createElement: function (t) {
    if (t === "div") {
      var d = { _text: "", get textContent() { return this._text; }, set textContent(v) { this._text = v; this.innerHTML = String(v).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#39;"); }, innerHTML: "", style: {}, remove: function () {} };
      return d;
    }
    if (t === "canvas") {
      var ctx = { _font: "", get font() { return this._font; }, set font(v) { this._font = v; }, measureText: function (t) { return { width: t.length * 10 }; }, fillStyle: "", textBaseline: "", fillText: function () {}, scale: function () {} };
      return { getContext: function () { return ctx; },       toDataURL: function () { return "data:image/png;base64,iVBORw0KGgo="; }, width: 0, height: 0 };
    }
    if (t === "script") {
    ...
    if (t === "a") {
      return { href: "", download: "", style: {}, click: function () {}, remove: function () {} };
    }
    if (t === "style") {
...
var mockJspdfDoc = {
  ...
  _font: undefined,
  _fontSize: 9,
  setFontSize: function (s) { this._fontSize = s; },
  setFont: function (_, b) { this._font = b; },
  text: function () {},
  addImage: function () {},
  addPage: function () { this._pages++; },
  splitTextToSize: function (t) { return [t]; },
  output: function () { return new Blob(["pdf"]); },
};
globalThis.jspdf = {
  jsPDF: function () {
...
var mockQRious = function (opts) {
  if (opts && opts.element && opts.element.toDataURL) {
    opts.element.toDataURL = function () { return "data:image/png;base64,cXJjb2Rl"; };
  }
};
...
globalThis.docx = {
  ...
  Packer: { toBlob: async function () { return new Blob(["docx"]); } },
};

var mockZipInstance = {
  file: function () { return this; },
  folder: function () {
    var f = { file: function () { return mockZipInstance; }, folder: function () { return f; } };
    return f;
  },
  generateAsync: async function () { return new Blob(["epub"]); },
};
globalThis.JSZip = function () { return Object.create(mockZipInstance); };

var mockOtsOps = {
  OpSHA256: function () {},
  OpAppend: function (d) { this.data = d; },
};
var mockOts = {
  DetachedTimestampFile: {
    fromHash: function (op, hash) {
      return {
        timestamp: {
          add: function (op) {
            var t = { add: function (op2) { return { attestations: [] }; } };
            return t;
          },
        },
        serializeToBytes: function () { return new Uint8Array([1, 2, 3]); },
      };
    },
  },
  Ops: mockOtsOps,
  Utils: {
    ...
    arrayToBytes: function (a) { return a; },
  },
  Notary: {
    PendingAttestation: function (url) { this.url = url; },
  },
};
...
srcPaths.forEach(function (rel) {
  ...
  vm.runInThisContext(clean, { filename: path.resolve(__dirname, "../../Certificate/" + path.basename(rel)) });
});
...
describe("Certificate UI — initCertPhoneCode", function () {
  ...
  it("should call getDefaultPhoneCode when available", function () {
    var called = false;
    globalThis.getDefaultPhoneCode = function () { called = true; return { dial: "+1" }; };
...
describe("Certificate UI — resetProfessionalCert", function () {
  ...
  it("should reset all form fields", function () {
    var ids = ["cert-file", "cert-name", "cert-phone", "cert-website", "cert-social-tiktok", "cert-show-music", "cert-music-fields", "cert-download-section", "cert-status", "cert-phonecode"];
    ...
    assert.equal(document.getElementById("cert-music-fields").style.display, "none");
    assert.equal(document.getElementById("cert-download-section").style.display, "none");
...
describe("Certificate — generatePendingOts", function () {
  ...
  it("should return null on error", function () {
    ...
    globalThis.OpenTimestamps.DetachedTimestampFile.fromHash = function () { throw new Error("fail"); };
    try {
      var result = generatePendingOts("aabbccdd");
      assert.strictEqual(result, null);
    } finally {
...
describe("Certificate — submitCertTransparency", function () {
  var origFetch;
  before(function () { origFetch = globalThis.fetch; resetEls(); });

  after(function () { globalThis.fetch = origFetch; });

  it("should return pending OTS when all aggregators fail", async function () {
    globalThis.fetch = async function () { throw new Error("Failed to fetch"); };
  ...
  it("should succeed when an aggregator responds", async function () {
    ...
    globalThis.fetch = async function (url) {
      return {
        ok: true,
        arrayBuffer: async function () { return new Uint8Array([10, 20, 30]).buffer; },
      };
    };
    var result = await submitCertTransparency(new Uint8Array([1, 2, 3]));
    assert.ok(result.submitted);
  ...
  it("should try next aggregator on HTTP error", async function () {
    ...
    globalThis.fetch = async function (url) {
      callCount++;
      if (callCount === 1) return { ok: false, status: 500, arrayBuffer: async function () { return new Uint8Array(); } };
      return {
        ok: true,
        arrayBuffer: async function () { return new Uint8Array([10, 20, 30]).buffer; },
      };
...
describe("Certificate — downloadProfessionalCert", function () {
  ...
  it("should alert when no cert data", function () {
    ...
    var msgs = [];
    globalThis.alert = function (m) { msgs.push(m); };
  ...
  it("should generate PDF when _certData exists", async function () {
    globalThis._certData = {
      ...
      generator: "Test",
      user: { name: "Tester", email: "t@t.com", phone: "+1234567890", website: "https://test.com" },
      file: { name: "test.jpg", size: 1024, type: "image/jpeg", width: 100, height: 100, dataUrl: "data:image/jpeg;base64,/9j/", hash: "abc123" },
      ct: { submitted: true, hash: "cthash123", timestamp: "2024-01-01T00:00:00.000Z", aggregator: "https://a.pool.opentimestamps.org/digest" },
      watermark: false,
      watermarkAlgo: "",
      watermarkResult: "",
  ...
  it("should generate DOCX when _certData exists", async function () {
    globalThis._certData = {
      ...
      file: { name: "test.jpg", size: 1024, type: "image/jpeg", width: 100, height: 100, dataUrl: "data:image/jpeg;base64,/9j/" },
      ct: { submitted: false },
      watermark: false,
      pixelInjection: false,
      timestamp: false,
  ...
  it("should generate EPUB when _certData exists", async function () {
    globalThis._certData = {
      ...
      generator: "Test",
      user: { name: "Tester", email: "t@t.com" },
      file: { name: "test.jpg", size: 1024, type: "image/jpeg", dataUrl: "data:image/jpeg;base64,/9j/" },
      ct: { submitted: false },
      watermark: false,
      pixelInjection: false,
      timestamp: false,
  ...
  it("should generate PDF with all features enabled", async function () {
    globalThis._certData = {
      generatedAt: "2024-01-01T00:00:00.000Z",
      generator: "Test",
      user: { name: "Tester", email: "t@t.com", phone: "+123", website: "https://test.com" },
      file: { name: "test.png", size: 2048, type: "image/png", width: 200, height: 100, dataUrl: "data:image/png;base64,iVBOR", hash: "hash123" },
      watermark: true,
      watermarkAlgo: "DCT",
      ...
      fingerprint: true,
      fpResult: { hashes: { "SHA-256": "abc", "SHA-1": "def", "BLAKE3": "ghi", "MD5": "jkl", "SHA-3_256": "mno" }, perceptual_hashes: { "dhash": "phash_val" } },
      ...
      didSig: { did: "did:key:z6MkhaXgBZDjot9W7K6ZoPwTyRnTqPZuLbSZNqJqRZpLJiTn", algorithm: "Ed25519", timestamp: "2024-01-01T00:00:00.000Z", signature: "sigval123456789012345678901234567890123456789012345678901234567890" },
      didIdentity: "",
      faceBiometric: { detected: true, faceCount: 1, matchLabel: "John Doe", didSigned: true, did: "did:key:z6Mk", exportedAt: "2024-01-01T00:00:00.000Z" },
      ct: { submitted: true, pending: false, hash: "cthash", timestamp: "2024-01-01T00:00:00.000Z", aggregator: "https://a.pool.opentimestamps.org/digest" },
    };
    await downloadProfessionalCert("pdf");
  });
  ...
  it("should generate PDF with ct.pending and minimal user", async function () {
    globalThis._certData = {
      ...
      generator: "Test",
      user: {},
      file: { name: "doc.png", size: 512, type: "image/png", dataUrl: "data:image/png;base64,iVBOR" },
      ct: { submitted: true, pending: true, hash: "pendhash", timestamp: "2024-01-01T00:00:00.000Z" },
      watermark: false,
      pixelInjection: false,
      timestamp: false,
      fingerprint: false,
  ...
  it("should generate DOCX with all features", async function () {
    globalThis._certData = {
      ...
      file: { name: "photo.png", size: 1024, type: "image/png", width: 400, height: 300,       dataUrl: "data:image/png;base64,iVBORw0KGgo=" },
      watermark: true,
      watermarkAlgo: "LSB",
      watermarkResult: "OK",
      pixelInjection: true,
      ...
      tsResult: "TS created",
      fingerprint: true,
      fpResult: { hashes: { "SHA-256": "abc", "SHA-1": "def" }, perceptual_hashes: { "dhash": "val" } },
      didSig: { did: "did:key:z6Mk123", algorithm: "Ed25519", timestamp: "2024-01-01T00:00:00.000Z", signature: "sig1234567890123456789012345678901234567890123456789012345678901234567890" },
      faceBiometric: { detected: true, faceCount: 2, matchLabel: "Face match", didSigned: true, did: "did:key:z6Mk", exportedAt: "2024-01-01T00:00:00.000Z" },
      ct: { submitted: true, hash: "cthash123", timestamp: "2024-01-01T00:00:00.000Z", aggregator: "https://a.pool.opentimestamps.org/digest" },
    };
    await downloadProfessionalCert("docx");
  });
  ...
  it("should generate EPUB with all features", async function () {
    globalThis._certData = {
      ...
      file: { name: "pic.jpg", size: 2048, type: "image/jpeg", width: 800, height: 600, dataUrl: "data:image/jpeg;base64,/9j/4AAQ" },
      watermark: true,
      watermarkAlgo: "DCT",
      ...
      fingerprint: true,
      fpResult: { hashes: { "SHA-256": "abc", "SHA-384": "def" }, perceptual_hashes: { "phash": "val" } },
      didSig: { did: "did:key:z6Mk456", algorithm: "P-256", timestamp: "2024-01-01T00:00:00.000Z", signature: "sig123456789012345678901234567890123456789012345678901234567890" },
      faceBiometric: { detected: true, faceCount: 3, didSigned: false, exportedAt: "2024-01-01T00:00:00.000Z" },
...
describe("Certificate — downloadOtsProof", function () {
  ...
  it("should do nothing when no CT result", function () {
    globalThis.getResult = function () { return null; };
    downloadOtsProof();
  });
});
...
describe("Certificate Utils — addTextSafe truncation", function () {
  ...
  it("should truncate wide non-Latin text", function () {
    var doc = {
      text: function () {},
      addImage: function () { this._addImageCalled = true; },
    ...
    document.createElement = function (t) {
      if (t === "canvas") {
        ...
        return {
          getContext: function () {
            return {
              font: "", measureText: function () { return { width: textWidth }; },
              fillStyle: "", textBaseline: "", fillText: function () {}, scale: function () {},
            };
          },
...
describe("Certificate Utils — makeUUID fallback via undefined", function () {
  it("should use regex fallback when randomUUID is undefined", function () {
    var origDesc = Object.getOwnPropertyDescriptor(globalThis.crypto, 'randomUUID');
    try {
      Object.defineProperty(globalThis.crypto, 'randomUUID', { value: undefined, writable: true, configurable: true });
      var id = makeUUID();
      assert.equal(id.length, 36);
      assert.equal(id[14], "4");
      assert.match(id, /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/);
    } finally {
      if (origDesc) Object.defineProperty(globalThis.crypto, 'randomUUID', origDesc);
    }
  });
});
...
describe("Certificate PDF — timestamp without tsResult", function () {
  ...
  it("should render default text when tsResult is empty", async function () {
    globalThis._certData = {
      ...
      ct: { submitted: false },
      watermark: false, pixelInjection: false,
      timestamp: true, tsResult: "",
      fingerprint: false, documentWatermark: false,
    };
    await downloadProfessionalCert("pdf");
  });
});
...
describe("Certificate EPUB — full branch coverage", function () {
  ...
  it("should generate EPUB with all branches", async function () {
    globalThis._certData = {
      generatedAt: "2024-01-01T00:00:00.000Z",
      generator: "Test",
      user: { name: "Bob", email: "b@c.com", phone: "+123", website: "https://test.com" },
      file: { name: "pic.jpg", size: 2048, type: "image/jpeg", width: 800, height: 600, dataUrl: "data:image/jpeg;base64,/9j/4AAQSkZJRg==", hash: "abc123def456" },
      watermark: true, watermarkAlgo: "DCT", watermarkResult: "Watermarked",
      pixelInjection: true, piResultHtml: "Injected",
      documentWatermark: true, documentWatermarkFileName: "docw.txt", documentWatermarkResult: "Doc watermark",
      timestamp: true, tsResult: "Timestamp created",
      fingerprint: true,
      fpResult: { hashes: { "SHA-256": "abc", "SHA-384": "def" }, perceptual_hashes: { "phash": "val" } },
      didSig: { did: "did:key:z6Mk456", algorithm: "P-256", timestamp: "2024-01-01T00:00:00.000Z", signature: "sig123456789012345678901234567890123456789012345678901234567890" },
      faceBiometric: { detected: true, faceCount: 3, matchLabel: "Known Person", did: "did:key:z6Mkface", didSigned: false, exportedAt: "2024-01-01T00:00:00.000Z" },
      ct: { submitted: true, pending: false, hash: "cthash456", timestamp: "2024-01-01T00:00:00.000Z", aggregator: "https://a.pool.opentimestamps.org/digest" },
    };
    await downloadProfessionalCert("epub");
  });
  ...
  it("should generate EPUB with didIdentity and ct.false", async function () {
    globalThis._certData = {
      ...
      didIdentity: "did:key:z6Mk789",
      ct: { submitted: false, error: "offline" },
      watermark: false, pixelInjection: false, timestamp: false, fingerprint: false, documentWatermark: false,
    };
    await downloadProfessionalCert("epub");
  });
});
...
describe("Certificate DOCX — remaining branches", function () {
  ...
  it("should generate DOCX with GIF image (imageTypeFromMime gif)", async function () {
    globalThis._certData = {
      ...
      generator: "Test",
      user: {},
      file: { name: "anim.gif", size: 512, type: "image/gif", width: 100, height: 100, dataUrl: "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" },
      ct: { submitted: false },
      watermark: false, pixelInjection: false, timestamp: false, fingerprint: false, documentWatermark: false,
    };
    await downloadProfessionalCert("docx");
  ...
  it("should generate DOCX with BMP image (imageTypeFromMime bmp)", async function () {
    globalThis._certData = {
      ...
      generator: "Test",
      user: {},
      file: { name: "img.bmp", size: 512, type: "image/bmp", width: 100, height: 100, dataUrl: "data:image/bmp;base64,Qk1CAAAAADYAAAAoAAAABAA" },
      ct: { submitted: false },
      watermark: false, pixelInjection: false, timestamp: false, fingerprint: false, documentWatermark: false,
    };
    await downloadProfessionalCert("docx");
  ...
  it("should generate DOCX with timestamp but no tsResult", async function () {
    globalThis._certData = {
      ...
      ct: { submitted: false },
      timestamp: true, tsResult: "",
      watermark: false, pixelInjection: false, fingerprint: false, documentWatermark: false,
    };
    await downloadProfessionalCert("docx");
  });
  ...
  it("should generate DOCX with unknown image type (default png)", async function () {
    globalThis._certData = {
      ...
      generator: "Test",
      user: {},
      file: { name: "img.webp", size: 512, type: "image/webp", width: 100, height: 100, dataUrl: "data:image/webp;base64,UklGRiQAAABXRUJQVlA4TBcAAAAv" },
      ct: { submitted: false },
      watermark: false, pixelInjection: false, timestamp: false, fingerprint: false, documentWatermark: false,
    };
    await downloadProfessionalCert("docx");
