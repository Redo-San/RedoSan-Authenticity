...
globalThis.jspdf.jsPDF = class {
  ...
  text(str, x, y) { this._calls.push(["text", str, x, y]); return this; }
...
class MockParagraph { constructor(o) { this.opts = o; } }
class MockTextRun { constructor(o) { this.opts = o; } }
class MockTable { constructor(o) { this.opts = o; } }
class MockTableRow { constructor(o) { this.opts = o; } }
class MockTableCell { constructor(o) { this.opts = o; } }
class MockDocument { constructor(o) { this.opts = o; } }
globalThis.docx = {
      ...
      return new docx.TableRow({
        children: row.map(function (cell) {
          return new docx.TableCell({
            children: [new docx.Paragraph({ children: [new docx.TextRun({ text: String(cell) })] })],
          });
        }),
      });
    }),
...
const mockResult = {
  ...
  manifest: {
    ...
    assertions: [
      { label: "c2pa.actions", data: [{ action: "c2pa.created", when: "2024-06-15T12:00:00Z" }] }
    ],
  },
  ...
  it("should handle page break when content exceeds page height", () => {
    ...
    const result = {
      ...
      manifest: {
        ...
        claim_generator_info: Array.from({ length: 10 }, (_, i) => ({ name: "Gen", version: String(i) })),
        assertions: [
          { label: "c2pa.actions", data: manyActions },
        ],
      },
      manifestStore: { validation_state: "ok" },
    };
