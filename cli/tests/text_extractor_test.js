...
vm.runInThisContext(cleanSrc, { filename: path.resolve(__dirname, "../../cli/lib/text_extractor.js") });
...
function createPdfWithCMap() {
  ...
  const parts = [
    ...
    Buffer.from("3 0 obj<</Type/Page/Parent 2 0 R/MediaBox[0 0 612 792]/Contents 4 0 R/Resources<</Font<</F1 5 0 R>>>>>>endobj\n"),
    Buffer.from(`4 0 obj<</Length ${content.length}>>stream\n${content}\nendstream\nendobj\n`),
    Buffer.from("5 0 obj<</Type/Font/Subtype/Type0/BaseFont/TestFont/ToUnicode 6 0 R>>endobj\n"),
    Buffer.from(`6 0 obj<</Length ${compressed.length}/Filter/FlateDecode>>stream\n`),
    compressed,
    Buffer.from("\nendstream\nendobj\n"),
    Buffer.from("xref\n0 1\n0000000000 65535 f \ntrailer\n<</Size 1>>\nstartxref\n0\n%%EOF\n"),
  ];
