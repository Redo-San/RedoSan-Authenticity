...
describe('Document Watermark UI — docwToCSV', () => {
  it('should produce CSV output with headers', () => {
    const r = { algo: 'ZWC', message: 'hello', timestamp: '2024-01-01', textLength: 100, hash: 'abc', resultLength: 50 };
...
describe('Document Watermark UI — docwToXML', () => {
  it('should produce XML output', () => {
    const r = { algo: 'ZWC', message: 'test msg', timestamp: '2024-01-01', textLength: 50, hash: 'abc', resultLength: 25 };
...
describe('Document Watermark UI — _docwBuildCertificateText', () => {
  it('should build certificate text with all fields', () => {
    const r = { algo: 'ZWC', message: 'secret', timestamp: '2024-06-01T00:00:00Z', textLength: 100, hash: 'sha256hash' };
