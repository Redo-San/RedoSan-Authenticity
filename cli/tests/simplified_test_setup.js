...
function setupSimplifiedGlobals() {
  ...
  _mockGetElementById = function (id) {
  ...
  globalThis.Event = function (type, opts) {
    this.type = type;
    this.bubbles = opts && opts.bubbles ? true : false;
  };
  globalThis.URL = {
  ...
  globalThis.__ = function (key) {
    ...
    var fallback = {
      "simplified.upload": "Upload",
      "simplified.ai_question": "AI Question",
      "simplified.fingerprint": "Fingerprint",
      "simplified.did_sign": "DID Sign",
      "simplified.watermark": "Watermark",
      "simplified.pixel_injection": "Pixel Injection",
      "simplified.c2pa": "C2PA",
      "simplified.timestamp": "Timestamp",
      "simplified.done": "Done",
      "simplified.audio_watermark": "Audio Watermark",
      "simplified.name": "Name",
      "simplified.email": "Email",
      "simplified.phone": "Phone",
      "simplified.website": "Website",
      "simplified.select_file": "Select a file",
  ...
  globalThis.watermarkEmbed = function () {
    return Promise.resolve({ ok: true, data: "watermarked" });
  };
  ...
  globalThis.awLoadAudio = function () {
    return { sampleRate: 44100, channels: 2, samples: new Int16Array(44100) };
  };
  globalThis.awWriteWav = function () {
    return new Uint8Array(100);
  };
  globalThis.awFormatPayload = function () {
    return new Uint8Array(100);
  };
  globalThis.pw_key = function () {
    return new Uint8Array(32);
  };
  globalThis.aw1_embed = function () {
    return { data: new Int16Array(100) };
  };
  globalThis.aw2_embed = function () {
    return { data: new Int16Array(100) };
  };
  globalThis.aw3_embed = function () {
    return { data: new Int16Array(100) };
  };
  globalThis.aw4_embed = function () {
    return { data: new Int16Array(100) };
  };
  globalThis.aw5_embed = function () {
    return { data: new Int16Array(100) };
  };
  globalThis.aw6_embed = function () {
    return { data: new Int16Array(100) };
  };
  globalThis.aw7_embed = function () {
    return { data: new Int16Array(100) };
  };
  globalThis.aw8_embed_async = function () {
    return Promise.resolve(new Int16Array(100));
  };
  globalThis.aw2_maxBits = function () {
    return 100;
  };
  globalThis.aw3_maxBits = function () {
    return 200;
  };
  globalThis.aw4_maxBits = function () {
    return 300;
  };
  globalThis.aw6_maxBits = function () {
    return 400;
  };
  globalThis.aw7_maxBits = function () {
    return 500;
  };
  globalThis.aw8_maxBits = function () {
    return 600;
  };
  ...
  globalThis.handleFingerprint = function () {
    return Promise.resolve({ ok: true, data: { sha256: "abc123" } });
  };
  ...
  globalThis.handlePixelInjection = function () {
    return Promise.resolve({ ok: true, url: "blob:pi" });
  };
  ...
  globalThis.phoneCodeOptionsHtml = function () {
