...
describe("MPA — Privacy Policy", function () {
  it("should load privacy page with correct title and metadata", async function () {
  ...
  it("should display privacy content", async function () {
