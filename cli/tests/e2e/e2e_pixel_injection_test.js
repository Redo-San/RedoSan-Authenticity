...
describe("E2E — Pixel Injection", () => {
  ...
  it("should round-trip Enhanced LSB: embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Watermarked image data URL should be available");
  ...
  it("should round-trip DCT: embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "DCT watermarked image URL should be available");
  ...
  it("should round-trip DWT: embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "DWT watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Multi-Channel LSB: embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "MC LSB watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip DFT: embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "DFT watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Hybrid DCT-DWT: embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Hybrid DCT-DWT watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Random LSB: embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Random LSB watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip VINE (deep learning): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "VINE watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Pixel Seal (deep learning): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Pixel Seal watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip NullGuard (deep learning): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "NullGuard watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Shallow Diffuse (deep learning): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Shallow Diffuse watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Imagewmark Pro (professional): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Imagewmark watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Meta Seal (professional): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Meta Seal watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip STARDUSTmark (professional): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "STARDUSTmark watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip InvisMark (professional): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "InvisMark watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip ElevenLikes (professional): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "ElevenLikes watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
  ...
  it("should round-trip Diffusion-based (professional): embed then extract recovers secret", async () => {
    ...
    assert.ok(imgDataUrl?.startsWith("data:"), "Diffusion-based watermarked image URL should be available");
    const base64Data = imgDataUrl.split(",")[1];
    const imgBuf = Buffer.from(base64Data, "base64");
