...
class C2paTabMixin:
    ...
    def _build_c2pa_tab(self):
        ...
        self._c2pa_creator_name_var = e.get()
        self._c2pa_creator_name_var.trace_add('w', lambda *args: self._auto_save_field('creator_name'))
        ...
        # Add trace for automatic saving
        self._c2pa_creator_id_var = e.get()
        self._c2pa_creator_id_var.trace_add('w', lambda *args: self._auto_save_field('creator_id'))
        ...
        # Add trace for automatic saving
        self._c2pa_ai_model_var = e.get()
        self._c2pa_ai_model_var.trace_add('w', lambda *args: self._auto_save_field('ai_model'))
        ...
        # Add trace for automatic saving
        self._c2pa_description_var = e.get()
        self._c2pa_description_var.trace_add('w', lambda *args: self._auto_save_field('description'))
        ...
        # Run button
        ctk.CTkButton(ctrl, text="Run", height=35, command=lambda: self._run_in_thread(self._c2pa_run)).grid(
            row=15, column=1, pady=10, sticky="w")
    ...
    def _auto_save_field(self, field_name):
        """Automatically save a single field to file"""
        try:
