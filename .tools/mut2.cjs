            ...
            for (const m of muts) {
              ...
              if (
                ...
                window.__mut.push({
                  ...
                  val: m.attributeName === "style" ? t.getAttribute("style") || "" : null,
                });
                ...
                window.__mut.push({
                  ...
                  removed:
                    ...
                    ":" +
                    String(m.removedNodes[0].id || m.removedNodes[0].className || "").slice(0, 30),
                });
              }
            }
          });
        ...
        try {
          new PerformanceObserver((l) => {
            for (const e of l.getEntries())
              if (!e.hadRecentInput) window.__clsRaw.push({ v: e.value, t: Math.round(e.startTime) });
