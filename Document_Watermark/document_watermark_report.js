...
async function _docwBuildReportPdf(r, mode) {
  ...
  var hash = isExtract
    ...
    : (r.hash || "").replace("SHA-256:", "") ||
      (await _docwHash(r.watermarkedText || ""));
  ...
  doc.text(
    "Digital Authenticity Certificate — Generated by RedoSan Authenticity",
    pw / 2,
    y,
    { align: "center" },
  );
  ...
  if (qrData) {
    ...
    doc.setFontSize(7);
    doc.setTextColor(120, 120, 140);
    doc.text("Scan to verify document integrity", pw / 2, y, {
      align: "center",
    });
    y += 3;
    try {
  ...
  if (hash) doc.text("SHA-256: " + hash, pw / 2, ph - 4, { align: "center" });
...
async function _docwBuildReportDocx(r, mode) {
  ...
  zip.file(
    "_rels/.rels",
    '<?xml version="1.0"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="word/document.xml"/></Relationships>',
  );
  zip.file(
    "word/_rels/document.xml.rels",
    '<?xml version="1.0"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="https://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/></Relationships>',
  );
