...
var ASSISTANT_KB = [
  {
    ...
    contexts: [],
    response: {
      en: "👋 Hello! I'm **Raido** 🤖, your AI assistant for RedoSan tools. I can help you with all the tools here.\n\nTry asking me:\n• How does watermarking work?\n• What is file fingerprinting?\n• How to create a timestamp?\n• Privacy & security\n\nWhat would you like to know?",
...

  {
    ...
    suggestions: {
      ...
      ar: ["كيف تعمل العلامة المائية؟", "الخصوصية والأمان", "ما هو C2PA؟"],
    },
  },

  {
    ...
    suggestions: {
      ...
      ar: ["كيف تعمل العلامة المائية؟", "ما هو OpenTimestamps؟", "ما هو C2PA؟"],
    },
  },
...

  {
    ...
    suggestions: {
      ...
      ar: [
        "كيفية تضمين العلامة المائية؟",
        "كيفية استخراج العلامة المائية؟",
        "الصيغ المدعومة",
      ],
    },
  },

  {
    ...
    suggestions: {
      ...
      ar: [
        "كيفية استخراج العلامة المائية؟",
        "ما الخوارزمية التي يجب استخدامها؟",
        "مساعدة كلمة المرور",
      ],
    },
  },
...

  {
    ...
    suggestions: {
      en: [
        "How to embed watermark?",
        "How to extract watermark?",
        "Watermark vs Pixel Injection",
      ],
      ar: [
        "كيفية تضمين العلامة المائية؟",
        "كيفية استخراج العلامة المائية؟",
        "العلامة المائية vs حقن البكسل",
      ],
    },
  },
...

  {
    ...
    suggestions: {
      en: [
        "How does pixel injection work?",
        "Watermark algorithms",
        "Pixel injection categories",
      ],
      ar: [
        "كيف يعمل حقن البكسل؟",
        "خوارزميات العلامة المائية",
        "فئات حقن البكسل",
      ],
    },
  },

  {
    ...
    suggestions: {
      en: [
        "How to inject a message?",
        "How to extract a message?",
        "Algorithm categories",
      ],
      ar: ["كيفية حقن رسالة؟", "كيفية استخراج رسالة؟", "فئات الخوارزميات"],
    },
  },

  {
    ...
    suggestions: {
      en: [
        "What is it used for?",
        "How to generate?",
        "Cryptographic vs perceptual",
      ],
      ar: ["ما فائدتها؟", "كيفية إنشائها؟", "التشفيرية vs الإدراكية"],
    },
  },

  {
    ...
    suggestions: {
      ...
      ar: ["كيفية إنشاء البصمة؟", "ما الخوارزميات؟", "جواز السفر الرقمي"],
    },
  },

  {
    ...
    suggestions: {
      ...
      ar: [
        "كيفية قراءة البيانات الوصفية؟",
        "ما المعلومات المخزنة؟",
        "كيفية إزالة البيانات الوصفية؟",
      ],
    },
  },

  {
    ...
    suggestions: {
      ...
      ar: [
        "كيفية إنشاء طابع زمني؟",
        "كيفية التحقق من طابع زمني؟",
        "إثبات blockchain",
      ],
    },
  },
...

  {
    ...
    suggestions: {
      en: [
        "How to sign with C2PA?",
        "How to read C2PA?",
        "How to verify C2PA?",
      ],
      ar: [
        "كيفية التوقيع بـ C2PA؟",
        "كيفية قراءة C2PA؟",
        "كيفية التحقق من C2PA؟",
      ],
    },
  },

  {
    ...
    suggestions: {
      en: ["How to read C2PA?", "How to verify C2PA?", "What is C2PA?"],
      ar: ["كيفية قراءة C2PA؟", "كيفية التحقق من C2PA؟", "ما هو C2PA؟"],
    },
  },

  {
    ...
    suggestions: {
      en: ["How to sign with C2PA?", "How to verify C2PA?", "What is C2PA?"],
      ar: ["كيفية التوقيع بـ C2PA؟", "كيفية التحقق من C2PA؟", "ما هو C2PA؟"],
    },
  },

  {
    ...
    suggestions: {
      en: ["How to sign with C2PA?", "How to read C2PA?", "What is C2PA?"],
      ar: ["كيفية التوقيع بـ C2PA؟", "كيفية قراءة C2PA؟", "ما هو C2PA؟"],
    },
  },

  {
    ...
    suggestions: {
      en: [
        ...
        "Supported formats",
        "What tools to use together?",
      ],
      ar: [
        "كيفية إنشاء شهادة؟",
        "الصيغ المدعومة",
        "ما الأدوات المستخدمة معاً؟",
      ],
    },
  },

  {
    ...
    suggestions: {
      ...
      ar: ["ما هو جواز السفر الرقمي؟", "الصيغ المدعومة", "دمج جميع الأدوات"],
    },
  },

  {
    ...
    suggestions: {
      en: ["How to convert?", "Supported formats", "Image conversion"],
      ar: ["كيفية التحويل؟", "الصيغ المدعومة", "تحويل الصور"],
    },
  },
...

  {
    ...
    contexts: ["forensic", "home"],
    response: {
      en: "**Forensic Analyzer** detects tampering in images using four techniques:\n\n1️⃣ **ELA (Error Level Analysis)** — Detects localized compression inconsistencies\n2️⃣ **Noise Analysis** — Finds regions with abnormal noise patterns\n3️⃣ **Copy-Move Detection** — Identifies duplicated image regions\n4️⃣ **JPEG Metadata** — Checks JPEG structure for anomalies\n\nAll analysis runs locally in your browser. No files are uploaded.\n\nTo use: go to the **Forensic Analyzer** page, upload an image, and click **Analyze Forensics**.",
      ar: "**محلل الطب الشرعي** يكتشف التلاعب في الصور باستخدام أربع تقنيات:\n\n1️⃣ **ELA (تحليل مستوى الخطأ)** — يكشف تناقضات الضغط الموضعية\n2️⃣ **تحليل الضوضاء** — يجد المناطق ذات أنماط الضوضاء غير الطبيعية\n3️⃣ **كشف النسخ واللصق** — يحدد مناطق الصور المكررة\n4️⃣ **بيانات JPEG الوصفية** — يفحص بنية JPEG بحثًا عن الحالات الشاذة\n\nجميع التحليلات تعمل محليًا في متصفحك. لا يتم رفع أي ملفات.\n\nللاستخدام: اذهب إلى صفحة **محلل الطب الشرعي**، ارفع صورة، وانقر **تحليل الطب الشرعي**.",
    },
    suggestions: {
      en: [
        "How does ELA work?",
        "What is copy-move detection?",
        "What tamper signals exist?",
      ],
      ar: ["كيف يعمل ELA؟", "ما هو كشف النسخ واللصق؟", "ما هي إشارات التلاعب؟"],
    },
  },
...

  {
    ...
    suggestions: {
      ...
      ar: ["الخصوصية والأمان", "كيف تعمل العلامة المائية؟", "ما هو C2PA؟"],
    },
  },

  {
    ...
    suggestions: {
      en: ["Privacy & Security", "Open source", "How does watermarking work?"],
      ar: ["الخصوصية والأمان", "مفتوح المصدر", "كيف تعمل العلامة المائية؟"],
    },
  },

  {
    ...
    contexts: [],
    response: {
      en: 'You can use the **search bar** in the top navigation! Just type a keyword like "watermark", "fingerprint", "sha256", "timestamp", "c2pa" and press Enter.\n\nOr you can ask me directly — what are you looking for?',
    ...
    suggestions: {
      ...
      ar: ["كيف تعمل العلامة المائية؟", "ما هي البصمة الرقمية؟", "ما هو C2PA؟"],
    },
  },

  {
    ...
    suggestions: {
      ...
      ar: ["ما هو الوضع المبسط؟", "ما الأدوات المتاحة؟", "الخصوصية والأمان"],
    },
  },
...

  {
    ...
    suggestions: {
      en: ["What is this tool?", "Open source", "Privacy & Security"],
      ar: ["ما هذه الأداة؟", "مفتوح المصدر", "الخصوصية والأمان"],
    },
  },
...

  {
    ...
    suggestions: {
      en: ["What tools are available?", "Is it free?", "Mobile support"],
      ar: ["ما الأدوات المتاحة؟", "هل هو مجاني؟", "دعم الجوال"],
    },
  },
...

  {
    ...
    contexts: [],
    response: {
      en: "I'm **Raido** 🤖, your AI assistant for **RedoSan Authenticity**!\n\nI'm here to help you with:\n💧 Digital Watermarking\n🔬 Pixel Injection\n🔍 File Fingerprinting\n📋 Metadata & EXIF\n🕒 OpenTimestamps\n✨ C2PA Content Provenance\n📜 Digital Passport\n🔄 File Converter\n\nWhat would you like help with?",
...

  {
    ...
    suggestions: {
      en: ["What is this tool?", "Open source", "Contact"],
      ar: ["ما هذه الأداة؟", "مفتوح المصدر", "اتصل بنا"],
    },
  },
];
